 ...
 */
public interface LibSixel extends Library {
	
	
	public static final String JNA_LIBRARY_NAME = "sixel";
	public static final NativeLibrary JNA_NATIVE_LIB = NativeLibrary.getInstance(LibSixel.JNA_LIBRARY_NAME);
	public static final LibSixel INSTANCE = (LibSixel)Native.load(LibSixel.JNA_LIBRARY_NAME, LibSixel.class);
	...
	public static interface pixelFormat {
		 ...
		 */
		public static final int PIXELFORMAT_RGB555 = (int)LibSixel.formatType.FORMATTYPE_COLOR | 0x01;
		/**
		 * 16bpp<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:68</i>
		 */
		public static final int PIXELFORMAT_RGB565 = (int)LibSixel.formatType.FORMATTYPE_COLOR | 0x02;
		/**
		 * 24bpp<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:69</i>
		 */
		public static final int PIXELFORMAT_RGB888 = (int)LibSixel.formatType.FORMATTYPE_COLOR | 0x03;
		/**
		 * 15bpp<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:70</i>
		 */
		public static final int PIXELFORMAT_BGR555 = (int)LibSixel.formatType.FORMATTYPE_COLOR | 0x04;
		/**
		 * 16bpp<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:71</i>
		 */
		public static final int PIXELFORMAT_BGR565 = (int)LibSixel.formatType.FORMATTYPE_COLOR | 0x05;
		/**
		 * 24bpp<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:72</i>
		 */
		public static final int PIXELFORMAT_BGR888 = (int)LibSixel.formatType.FORMATTYPE_COLOR | 0x06;
		/**
		 * 32bpp<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:73</i>
		 */
		public static final int PIXELFORMAT_ARGB8888 = (int)LibSixel.formatType.FORMATTYPE_COLOR | 0x10;
		/**
		 * 32bpp<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:74</i>
		 */
		public static final int PIXELFORMAT_RGBA8888 = (int)LibSixel.formatType.FORMATTYPE_COLOR | 0x11;
		/**
		 * 1bpp grayscale<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:75</i>
		 */
		public static final int PIXELFORMAT_G1 = (int)LibSixel.formatType.FORMATTYPE_GRAYSCALE | 0x00;
		/**
		 * 2bpp grayscale<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:76</i>
		 */
		public static final int PIXELFORMAT_G2 = (int)LibSixel.formatType.FORMATTYPE_GRAYSCALE | 0x01;
		/**
		 * 4bpp grayscale<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:77</i>
		 */
		public static final int PIXELFORMAT_G4 = (int)LibSixel.formatType.FORMATTYPE_GRAYSCALE | 0x02;
		/**
		 * 8bpp grayscale<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:78</i>
		 */
		public static final int PIXELFORMAT_G8 = (int)LibSixel.formatType.FORMATTYPE_GRAYSCALE | 0x03;
		/**
		 * 16bpp gray+alpha<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:79</i>
		 */
		public static final int PIXELFORMAT_AG88 = (int)LibSixel.formatType.FORMATTYPE_GRAYSCALE | 0x13;
		/**
		 * 16bpp gray+alpha<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:80</i>
		 */
		public static final int PIXELFORMAT_GA88 = (int)LibSixel.formatType.FORMATTYPE_GRAYSCALE | 0x23;
		/**
		 * 1bpp palette<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:81</i>
		 */
		public static final int PIXELFORMAT_PAL1 = (int)LibSixel.formatType.FORMATTYPE_PALETTE | 0x00;
		/**
		 * 2bpp palette<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:82</i>
		 */
		public static final int PIXELFORMAT_PAL2 = (int)LibSixel.formatType.FORMATTYPE_PALETTE | 0x01;
		/**
		 * 4bpp palette<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:83</i>
		 */
		public static final int PIXELFORMAT_PAL4 = (int)LibSixel.formatType.FORMATTYPE_PALETTE | 0x02;
		/**
		 * 8bpp palette<br>
		 * <i>native declaration : /usr/include/sixel/sixel.h:84</i>
		 */
		public static final int PIXELFORMAT_PAL8 = (int)LibSixel.formatType.FORMATTYPE_PALETTE | 0x03;
	};
	/**
	 * palette type<br>
	 ...
	 */
	int sixel_allocator_new(PointerByReference ppallocator, LibSixel.sixel_malloc_t fn_malloc, LibSixel.sixel_calloc_t fn_calloc, LibSixel.sixel_realloc_t fn_realloc, LibSixel.sixel_free_t fn_free);
	/**
	 ...
	 * @deprecated use the safer method {@link #sixel_output_new(com.sun.jna.ptr.PointerByReference, LibSixel.SixelLibrary.sixel_write_function, com.sun.jna.Pointer, com.sun.jna.ptr.PointerByReference)} instead
	 */
	@Deprecated 
	int sixel_output_new(PointerByReference output, LibSixel.sixel_write_function fn_write, Pointer priv, Pointer allocator);
	/**
	 * create new output context object<br>
	 * Original signature : <code>SIXELSTATUS sixel_output_new(sixel_output_t**, sixel_write_function, void*, sixel_allocator_t*)</code><br>
	 * @param output output object to be created<br>
	 ...
	 */
	int sixel_output_new(PointerByReference output, LibSixel.sixel_write_function fn_write, Pointer priv, PointerByReference allocator);
	/**
	 ...
	 */
	PointerByReference sixel_output_create(LibSixel.sixel_write_function fn_write, Pointer priv);
	/**
	 ...
	 * @deprecated use the safer methods {@link #sixel_decode(java.nio.ByteBuffer, int, com.sun.jna.ptr.PointerByReference, java.nio.IntBuffer, java.nio.IntBuffer, com.sun.jna.ptr.PointerByReference, java.nio.IntBuffer, LibSixel.SixelLibrary.sixel_allocator_function)} and {@link #sixel_decode(com.sun.jna.Pointer, int, com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.IntByReference, com.sun.jna.ptr.PointerByReference, com.sun.jna.ptr.IntByReference, LibSixel.SixelLibrary.sixel_allocator_function)} instead
	 */
	@Deprecated 
	int sixel_decode(Pointer sixels, int size, PointerByReference pixels, IntByReference pwidth, IntByReference pheight, PointerByReference palette, IntByReference ncolors, LibSixel.sixel_allocator_function fn_malloc);
	/**
	 * Original signature : <code>SIXELSTATUS sixel_decode(unsigned char*, int, unsigned char**, int*, int*, unsigned char**, int*, sixel_allocator_function)</code><br>
	 * @param sixels sixel bytes<br>
	 * @param size size of sixel bytes<br>
	 ...
	 */
	int sixel_decode(ByteBuffer sixels, int size, PointerByReference pixels, IntBuffer pwidth, IntBuffer pheight, PointerByReference palette, IntBuffer ncolors, LibSixel.sixel_allocator_function fn_malloc);
	/**
	 ...
	 * @deprecated use the safer methods {@link #sixel_helper_load_image_file(java.lang.String, int, int, int, java.nio.ByteBuffer, int, LibSixel.SixelLibrary.sixel_load_image_function, int, int[], com.sun.jna.Pointer, com.sun.jna.ptr.PointerByReference)} and {@link #sixel_helper_load_image_file(com.sun.jna.Pointer, int, int, int, com.sun.jna.Pointer, int, LibSixel.SixelLibrary.sixel_load_image_function, int, com.sun.jna.ptr.IntByReference, com.sun.jna.Pointer, com.sun.jna.ptr.PointerByReference)} instead
	 */
	@Deprecated 
	int sixel_helper_load_image_file(Pointer filename, int fstatic, int fuse_palette, int reqcolors, Pointer bgcolor, int loop_control, LibSixel.sixel_load_image_function fn_load, int finsecure, IntByReference cancel_flag, Pointer context, Pointer allocator);
	/**
	 * Original signature : <code>SIXELSTATUS sixel_helper_load_image_file(const char*, int, int, int, unsigned char*, int, sixel_load_image_function, int, const int*, void*, sixel_allocator_t*)</code><br>
	 * @param filename source file name<br>
	 * @param fstatic whether to extract static image<br>
	 ...
	 */
	int sixel_helper_load_image_file(String filename, int fstatic, int fuse_palette, int reqcolors, ByteBuffer bgcolor, int loop_control, LibSixel.sixel_load_image_function fn_load, int finsecure, int cancel_flag[], Pointer context, PointerByReference allocator);
	/**
	 * Original signature : <code>SIXELSTATUS sixel_helper_load_image_file(const char*, int, int, int, unsigned char*, int, sixel_load_image_function, int, const int*, void*, sixel_allocator_t*)</code><br>
	 * @param filename source file name<br>
	 * @param fstatic whether to extract static image<br>
	 ...
	 * <i>native declaration : /usr/include/sixel/sixel.h:581</i>
	 */
	int sixel_helper_load_image_file(Pointer filename, int fstatic, int fuse_palette, int reqcolors, Pointer bgcolor, int loop_control, LibSixel.sixel_load_image_function fn_load, int finsecure, IntByReference cancel_flag, Pointer context, PointerByReference allocator);
	/**
