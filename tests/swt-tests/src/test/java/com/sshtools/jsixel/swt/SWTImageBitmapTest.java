...
public class SWTImageBitmapTest extends AbstractImageBitmapTests {
	
	@Test
	public void testLoader() {
		// Just make sure we have the right loader
		assertTrue(SixelConverter.defaultCodec() instanceof SWTImageLoader);
	}
	...
	public void testAlphaPngGrayScale16() throws Exception {
		simpleTest("/test.alpha.grayscale16.png", "/results/test.alpha.grayscale16.png.sixel");
	}
